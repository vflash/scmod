...
Result.prototype = {
        ...
        if (this.type === 'js') {
            ...
            while(x = rgxCommonJS2My.exec(data)) {
                ...
                */
                ...
                deps.push((type !== 'module' ? '+[' + type + '] ' : '') + mUrl);
            };

            end(true, {
                modules: deps,
                scripts: [
                    '+[common-js] ' + this.src.href
                ]
            });
            return;
        };
    ...
    jswrap: function(op, data, end) {
        if (op.type === 'common-js') {
            var shead = '__MODULE(\'' + op.moduleID + '\', function(global,exports){_RqARGS=arguments;'
                + '_RqARGS[_RqARGS.length-1](function(){return[global,module.ex!==module.exports?module.exports:exports]});'
                + (!op.prox ? '\n' : '')
                ;
            var sfoot = '\n});';
