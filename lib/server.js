...
var cmd_css = require('./cmd-css.js');
...
function ServerHendler(req, res) {
    ...
    if (!rgxHostName.test(xsrc.hostname) ) {
        ...
        if (referer) {
            if (req.xStartHost !== (referer.protocol + '//' + referer.host)) {
                ...
                xhost.query.src = formatURL(null, referer, q.query.src);
        ...
        src = formatURL(null, req.xStartHost, src);
    ...
    function go() {
        ...
        var url_exclude = formatURL(req.xStartHost, xsrc, q.query.core, req.replaceHash);
    ...
    var url_replace = formatURL(req.xStartHost, xsrc, q.query.rep, false);
